    ...
    void searchMyMenuTest() throws Exception {
        ...
        List<MenuFindResponse> menuFindResponses = List.of(
                new MenuFindResponse(1L, franchise, "menu1.com",
                        "슈렉 프라푸치노", "그린티 프라푸치노",
                        author, "맛있습니다.", 0, 8000, optionFindResponses, tasteFindResponses,
        ...
        given(menuService.searchMyMenu(accountId, request)).willReturn(
                new SearchMyMenuResponse(menuFindResponses));
                ...
                .andDo(document("search-my-menu",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("menu[].franchise.id").type(JsonFieldType.NUMBER)
                                        .description("프렌차이즈 ID"),
                                fieldWithPath("menu[].franchise.logoUrl").type(JsonFieldType.STRING)
                                ...
                                fieldWithPath("menu[].tasteList[]").type(JsonFieldType.ARRAY)
                                        .description("메뉴 맛 배열"),
                                fieldWithPath("menu[].tasteList[].tasteId").type(JsonFieldType.NUMBER)
                                        .description("맛 ID"),
                                fieldWithPath("menu[].tasteList[].tasteName").type(JsonFieldType.STRING)
                                        .description("맛 이름"),
                                fieldWithPath("menu[].tasteList[].tasteColor").type(JsonFieldType.STRING)
                                        .description("맛 색상 코드")
                        )
                ));
    }

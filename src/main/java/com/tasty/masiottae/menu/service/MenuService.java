...
import static com.tasty.masiottae.common.exception.ErrorMessage.NOT_ACCESS_ANOTHER_ACCOUNT;
...
public class MenuService {
    ...
    public void updateMenu(Long menuId, MenuUpdateRequest request, MultipartFile image,
        ...
        if (!originMenu.getAccount().getId().equals(account.getId())) {
            throw new ForbiddenException(NOT_ACCESS_ANOTHER_ACCOUNT.getMessage());
        }
